...
export const resolve = async (specifier, context, nextResolve) => {
    ...
    const isParentedFileUrl = Boolean(context.parentURL) && (parsedUrl === null || parsedUrl === void 0 ? void 0 : parsedUrl.protocol) === 'file:';
    const shouldTransformParentedFileUrl = isParentedFileUrl && TRANSFORMABLE_SOURCE_EXTENSIONS.has(extname(parsedUrl.pathname).toLowerCase());
